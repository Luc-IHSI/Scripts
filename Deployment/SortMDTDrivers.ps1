...
$FileToEdit = "M:\DeploymentShares\Control\DriverGroups.xml"

#Set the export path where you want the new file to go.
$exportPath = "M:\DeploymentShares\Control\DriverGroups.xml"
...
$BackupFolderPath = 'M:\DeploymentShares\Control\DriverGroupsBKP\'
