...
msiexec /i "$downloadDir\cisco-secure-client-win-5.1.8.122-core-vpn-predeploy-k9.msi" PRE_DEPLOY_DISABLE_VPN=1 /norestart /passive LOCKDOWN=2  /lvx* vpninstall.log
Start-Sleep -Seconds 60
msiexec /i "$downloadDir\cisco-secure-client-win-5.1.8.122-umbrella-predeploy-k9.msi"  /norestart /passive LOCKDOWN=2  /lvx* umbrellainstall.log
Start-Sleep -Seconds 60
msiexec /i "$downloadDir\cisco-secure-client-win-5.1.8.122-dart-predeploy-k9.msi"  /norestart /passive LOCKDOWN=2  /lvx* dartinstall.log
