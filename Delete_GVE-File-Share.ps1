...
$VaultName = "GVE-File-Share" #fetch automatically
$Subscription = "IHSI_CSP" #fetch automatically
$ResourceGroup = "GVE-PROD-RG" #fetch automatically
$SubscriptionId = "ef7c5f00-2245-4239-a450-4cb18680c3f5" #fetch automatically
