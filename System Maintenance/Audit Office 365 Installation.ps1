...
# $StatusCustomField = 'officeUpdateStatus' # Text field showing information on the status of the installed version.
...
$CardHTML.Add('<div style="display: flex; justify-content: flex-start;">')  # left-aligned container
$CardHTML.Add('<div class="card" style="max-width: 500px; width: 100%; margin: 0 auto;">')  # limited width card
